        ...
        <div>
            <div className="flex relative ">
                            ...
                            <div className="absolute bottom-0 flex flex-col top-0 left-0 right-0">
                                ...
                                <div className="flex-1 flex">
                                    ...
                                    <div className="bg-[#18b5de] flex-1 p-4  flex flex-col  justify-center gap-2 text-[#ffffff]">
                                        <p className="text-lg font-Montserrat font-semibold ">Formulation Development</p>
                        ...
                        <div className="flex-1 flex flex-col">
                            <div className=" flex-1  flex">
                                <div className=" flex-1 p-4 flex flex-col  justify-center gap-2 bg-[#ffffff]">
                                    <p className="text-primart_clr text-lg font-Montserrat font-bold ">Custom Chemical Synthesis</p>
                                    <p className="text-[#616179] text-sm font-Roboto font-normal">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                    </p>
                                </div>
                                <div className="flex-1 p-4 flex flex-col  justify-center gap-2 bg-[#103cac] text-[#ffffff]" >
                                    <p className="text-lg font-Montserrat font-semibold ">Analytical & Testing Services</p>
                                    <p className="text-sm font-Roboto font-normal">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                    </p>
                                </div>
                            ...
                            <div className=" flex-1 flex">
                                <div className=" flex-1 p-4 flex flex-col  justify-center gap-2 bg-[#04215d] text-[#ffffff] ">
                                    <p className="text-lg font-Montserrat font-bold ">Quality Control & Assurance</p>
                                    <p className="text-sm font-Roboto font-normal">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                    </p>
                                </div>
                                <div className=" flex-1 p-4 flex flex-col  justify-center gap-2 bg-[#ebeef3] text-[#04215d] " >
                                    <p className="text-lg font-Montserrat font-semibold ">Research & Development (R&D)</p>
                                    <p className="text-sm font-Roboto font-normal">
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                    </p>
                                </div>
                ...
                <div className="bg-[#ffffff] flex-1 py-4">
                    <div className=" lg:-translate-x-[13.5%] mt-[150%] sm:mt-[112%] md:mt-[85%] lg:mt-[50%]">
                        <div className="py-5 lg:p-0">
                            <p className=" text-[48px] text-[#171151] font-Montserrat text-center lg:text-start font-bold ">Industry Solutions</p>
                        </div>
                                    ...
                                    Solutions && Solutions.map((item) => (
                                        ...
                                        ${item.id === 4 ? " " : "border-b-[0.1px] border-b-[#ebeef3]"}  py-1`} key={item.id}>
                                            <div className="flex items-center gap-6 ">
                                                <div className="bg-[#ceeff8] h-[60.5px] w-[60.5px] rounded-full  relative">
                                                    <Image
                                                        src={lab}
                                                        alt='lab'
                                                        width={35}
                                                ...
                                                <div className="text-[#171151]">
                                                    <p className="font-Roboto font-normal text-sm">{item.number}</p>
                                                    <p className="font-Montserrat font-medium text-[18px]">{item.title}</p>
                                                </div>
                                            </div>
                                            <div>
